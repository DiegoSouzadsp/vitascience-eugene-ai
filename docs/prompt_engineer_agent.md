...
## Dados de Input
- Contexto RAG do livro "Breakthrough Advertising"
- Exemplos de VSL de diferentes níveis de consciência
- Estrutura JSON esperada para output
- Critérios de qualidade para validação de prompts
...
```json
{
  "system_prompts": {
    "consciousness_classifier": {
      "role": "Eugene Schwartz Consciousness Analyzer",
      "task": "Classificar nível de consciência 1-5",
      "context_retrieval": "get_consciousness_level_context",
      "output_format": "structured_json"
    },
    "structural_analyzer": {
      "role": "Copy Structure Expert", 
      "task": "Identificar frameworks (PAS, AIDA, etc)",
      "context_retrieval": "get_framework_guidance",
      "output_format": "framework_analysis"
    },
    "problem_identifier": {
      "role": "Copy Audit Specialist",
      "task": "Identificar problemas e fraquezas",
      "context_retrieval": "get_improvement_techniques", 
      "output_format": "problem_list"
    },
    "improvement_generator": {
      "role": "Eugene Schwartz Improvement Consultant",
      "task": "Gerar melhorias específicas",
      "context_retrieval": "get_improvement_techniques",
      "output_format": "improvement_suggestions"
    },
    "angle_creator": {
      "role": "Creative Angle Generator",
      "task": "Criar novos ângulos por nível",
      "context_retrieval": "get_creative_angles",
      "output_format": "angle_variations"
    }
  },
  "few_shot_examples": [...],
  "validation_tests": [...]
...
- `rag_retrieval_mcp`: Para busca contextual no conhecimento Eugene
- `llm_testing_mcp`: Para testes de qualidade de prompts
- `json_validator_mcp`: Para validação de outputs estruturados
- `prompt_optimizer_mcp`: Para otimização iterativa
...
### Exemplo para Nível 2 (Consciente do Problema)
```json
{
  "vsl_exemplo": "Você sabe que precisa emagrecer, mas já tentou de tudo...",
  "analise_esperada": {
    "nivel_identificado": 2,
    "justificativa": "Pressupõe conhecimento do problema (sobrepeso) e frustrações anteriores, típico de nível 2",
    "indicadores": ["já tentou de tudo", "você sabe que precisa"]
  }
}
```
